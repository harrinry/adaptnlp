# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/05_embeddings.ipynb (unless otherwise specified).

__all__ = ['logger', 'FLAIR_PRETRAINED_MODEL_NAMES', 'EasyWordEmbeddings', 'EasyStackedEmbeddings',
