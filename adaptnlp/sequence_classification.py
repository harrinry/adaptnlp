...
class SequenceResult:
    ...
    def __init__(self, sentences:List[Sentence]):
        ...
        self.vocab = sentences[0].get_label_names()
...
class TransformersSequenceClassifier(AdaptiveModel):
    ...
    * **model** - A transformers Sequence Classsifciation model
    ...
    def predict(
        ...
        * **detail_level** - String or DetailLevel of what amount of information should be returned. If `None` will return `SequenceResult`
        * **kwargs**(Optional) - Optional arguments for the Transformers classifier
        ...
        return results.to_dict(detail_level) if detail_level is not None else results
...
class EasySequenceClassifier:
    ...
    def tag_text(
        ...
        **return** Either a dict or a `SequenceResult`
        """
    ...
    def tag_all(
        ...
        * **return** - Either a dict or a `SequenceResult`
        ...
        results = SequenceResult(sentences)
