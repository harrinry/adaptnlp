# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/13c_transformers.utils_squad_evaluate.ipynb (unless otherwise specified).

__all__ = ['EVAL_OPTS', 'OPTS', 'parse_args', 'make_qid_to_has_ans', 'normalize_answer', 'get_tokens', 'compute_exact',
           'compute_f1', 'get_raw_scores', 'apply_no_ans_threshold', 'make_eval_dict', 'merge_eval', 'plot_pr_curve',
           'make_precision_recall_eval', 'run_precision_recall_analysis', 'histogram_na_prob', 'find_best_thresh',
           'find_best_thresh_v2', 'find_all_best_thresh', 'find_all_best_thresh_v2', 'main']

# Cell
# Code used/modified by AdaptNLP author from pytorch-transformers library
#
